    ...
    <footer>
      <div>
        <p>
          ...
          intellectuelle de wild Fox Ink.
          ...
          wild Fox Ink. Tous droits réservés.
        </p>
        <div className="links">
          <p>
            <a
              href="https://instagram.com/wild.fox.ink?igshid=MmU2YjMzNjRlOQ=="
              target="_blank"
            ...
            <a
              href="https://www.tiktok.com/@wild.fox.ink?_t=8eyGmgUInQ0&_r=1"
              target="_blank"
              rel="noopener noreferrer"
              className="link"
            >
